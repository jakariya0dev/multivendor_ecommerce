...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let imagesList = dragbox.find(".imageuploadify-imgs-list");
			let addIcon = dragbox.find(".imageuploadify-imgs-list i");
			let addMsg = dragbox.find(".imageuploadify-imgs-list span");
			let button = dragbox.find(".imageuploadify-imgs-list button");
