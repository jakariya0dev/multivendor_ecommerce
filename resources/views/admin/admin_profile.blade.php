                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="{{ (empty($user->photo)) ? asset('imgs/no_image.jpg') : asset('imgs/admin/'.$user->photo) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                        <div class="mt-3">
                                            <h4>{{ $user->name }}</h4>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.update') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <img id="image" class="mb-0" src="{{ (empty($user->photo)) ? asset('imgs/no_image.jpg') : asset('imgs/admin/'.$user->photo) }}"
