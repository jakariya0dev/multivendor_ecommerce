        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (empty(Auth::user()->photo)) ? asset('imgs/no_image.jpg') : asset('imgs/admin/'.$user->photo) }}" class="user-img" alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('admin.password.update') }}"><i class="bx bx-cog"></i><span> Change Password </span></a>
                    </li>
                    <li><a class="dropdown-item" href=""><i class='bx bx-home-circle'></i><span>Dashboard</span></a>
                    <li><a class="dropdown-item" href=""><i class='bx bx-download'></i><span>Downloads</span></a></li>
                    <li>
