...
<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="{{ asset('assets/backend/imgs/logo-icon.png') }}" class="logo-icon" alt="logo icon">
        </div>
        <div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('subcategory.index') }}"><i class="bx bx-right-arrow-alt"></i>All SubCategories</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{ route('product.index') }}"><i class="bx bx-right-arrow-alt"></i>All Product</a>
                </li>
                <li>
        ...
        <li>
            <a href="javascript:" class="has-arrow">
                ...
                <div class="menu-title">Mange Vendors</div>
            </a>
            <ul>
                <li> <a href="{{ route('vendor.all') }}"><i class="bx bx-right-arrow-alt"></i>All Vendors</a></li>
                <li> <a href="{{ route('vendor.active') }}"><i class="bx bx-right-arrow-alt"></i>Active Vendors</a></li>
                <li> <a href="{{ route('vendor.inactive') }}"><i class="bx bx-right-arrow-alt"></i>Inactive Vendors</a></li>
            </ul>
        </li>
        <li>
