    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href="#">{{ $product['category']['category_name'] }}</a> <span></span> {{ $product['subcategory']['subcategory_name'] }}
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    @foreach($productImages as $productImage)
                                        <figure class="border-radius-10">
                                            <img src="{{ asset($productImage->photo_name) }}" alt="product image" />
                                        </figure>
                                    @endforeach
                                </div>
                                <!-- THUMBNAILS -->
                                <div class="slider-nav-thumbnails">
                                    @foreach($productImages as $productImage)
                                        <div><img src="{{ asset($productImage->photo_name) }}" alt="product image" /></div>
                                    @endforeach
                                </div>
                            </div>
                            <!-- End Gallery -->
                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        @if($product->discount_price != null)
                                            ...
                                            <span>
                                                <span class="save-price font-md color3 ml-15">{{ round((($product->selling_price-($product->selling_price - $product->discount_price))/$product->selling_price)*100) }}% Off</span>
                                ...
                                <div class="font-xs">
                                    ...
                                    <ul class="float-start">
                                        <li class="mb-5">Product Code: {{ $product->product_code }} </li>
                            ...
                            <div class="tab-content shop_info_tab entry-main-content">
                                ...
                                <div class="tab-pane fade" id="Vendor-info">
                                    <div class="vendor-logo d-flex mb-30">
                                        <img src="{{ asset($product['vendor']['photo']) }}" alt="Vendor Image" />
                                        ...
                                        <div class="product-cart-wrap hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="{{ url('/product/'.$relatedProduct->id.'/'.$relatedProduct->product_slug) }}" tabindex="0">
                                                        <img class="default-img" src="{{ asset($relatedProduct->product_thumbnail) }}" alt="{{ $relatedProduct->product_name }}" />
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                                    <a id="{{ $relatedProduct->id }}" onclick="quickView(this.id)" aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                                                    <a id="{{ $relatedProduct->id }}" onclick="addToWishList(this.id)" aria-label="Add To Wishlist" class="action-btn small hover-up" tabindex="0"><i class="fi-rs-heart"></i></a>
                                                ...
                                                <div class="product-badges product-badges-position product-badges-mrg">
                                                    ...
                                                    @else
                                                        <span class="hot"> {{ round((($relatedProduct->selling_price-($relatedProduct->selling_price - $relatedProduct->discount_price))/$relatedProduct->selling_price)*100) }}% </span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ url('/product/'.$relatedProduct->id.'/'.$relatedProduct->product_slug) }}" tabindex="0">{{ $relatedProduct->product_name }}</a></h2>
                                                ...
                                                <div class="product-price">
                                                    ...
                                                    @else
                                                        <span>${{ $relatedProduct->selling_price - $relatedProduct->discount_price }}</span>
