...
@foreach([4, 6, 8] as $category_id)

    @php
        $products = \App\Models\Product::where('status', 1)->where('category_id', $category_id)->latest()->limit(5)->get();
    @endphp

    <section class="product-tabs section-padding position-relative">
        <div class="container">
            <div class="section-title style-2 wow animate__animated animate__fadeIn">
                <h3>{{ $products[0]['category']['category_name'] }} Category </h3>
