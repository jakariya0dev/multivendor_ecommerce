@php
    $recent_products = \App\Models\Product::where('status', 1)->orderBy('id', 'DESC')->limit(5)->get();
@endphp
        ...
        <div class="container">
            <div class="archive-header">
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        <h1 class="mb-15">{{ $products[0]['category']['category_name'] }}</h1>
                        <div class="breadcrumb">
                            <a href="{{ route('home') }}" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                            <span></span> Category <span></span> {{ $products[0]['category']['category_name'] }}
                        </div>
                    </div>
