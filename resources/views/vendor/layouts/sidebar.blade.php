...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{ route('vendor-product.index') }}"><i class="bx bx-right-arrow-alt"></i>All Product</a>
                </li>
                <li>
                    <a href="{{ route('vendor-product.create') }}"><i class="bx bx-right-arrow-alt"></i>Add Product</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                ...
                <li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Contatcs</a>
                </li>
